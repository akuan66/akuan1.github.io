...
.push([
	["pagesA-custom-custom"],
	{
					...
					a = {
						...
						mounted: function()
						{
							...
							(function()
							{
								...
								t.popupWidth = n, t.popupHeight = i + (o || 0), a && t.safeArea ? t.safeAreaInsets = r.bottom : t.safeAreaInsets = 0
							})()
						},
						destroyed: function()
						{
		...
		"21c0": function(t, e, n)
		{
			...
			n("bb96");
			var r = n("f0c5"),
				u = Object(r["a"])(o["default"], i["b"], i["c"], !1, null, "3193bb52", null, !1, i["a"], void 0);
			e["default"] = u.exports
		},
		2290: function(t, e, n)
		{
					...
					}, [t._l(t.customArr, (function(e)
					{
						return n("uni-section",
						{
							...
							scopedSlots: t._u([
							{
								...
								fn: function()
								{
									return [1 != e.id && 28 != e.id ? n("u--text",
									{
										attrs:
										{
											type: "warning",
		...
		"3e0e": function(t, e, n)
		{
			...
			{
				value: !0
			}), e.default = void 0, n("c740"), n("498a"), n("4de4"), n("d3b7"), n("99af"), n("7db0"), n("d81d"), n("cb29");
			var o = i(n("2909")),
				a = i(n("5530")),
				r = n("26cb"),
				u = n("aaec"),
				s = {
					...
					{}, (0, r.mapState)(["userCustomList"])),
					onLoad: function(t)
					{
						this.editId = t.editId, this.initData()
					},
					methods: (0, a.default)((0, a.default)(
					{}, (0, r.mapMutations)(["setUserCustomList"])),
					{},
					{
						redomInput: function(t)
						{
							...
							e ? this.customArr[e].text = this.$_.sample(u.data) : uni.showToast(
							{
								title: "生成失败",
								icon: "none"
							})
						...
						initData: function()
						{
							...
							if (this.editId)
							{
								...
								e ? (this.title = "编辑(".concat(e.title, ")"), uni.setNavigationBarTitle(
								{
									title: this.title
								}), this.customArr = e.arr) : this.initMy()
							}
							else this.initMy()
						},
						initMy: function()
		...
		{
			var i = n("24fb");
			e = i(!1), e.push([t.i, '@charset "UTF-8";\r\n/**\r\n * 这里是uni-app内置的常用样式变量\r\n *\r\n * uni-app 官方扩展插件及插件市场（https://ext.dcloud.net.cn）上很多三方插件均使用了这些样式变量\r\n * 如果你是插件开发者，建议你使用scss预处理，并在插件代码中直接使用这些变量（无需 import 这个文件），方便用户通过搭积木的方式开发整体风格一致的App\r\n *\r\n */\r\n/**\r\n * 如果你是App开发者（插件使用者），你可以通过修改这些变量来定制自己的插件主题，实现自定义主题功能\r\n *\r\n * 如果你的项目同样使用了scss预处理，你也可以直接在你的 scss 代码中使用如下变量，同时无需 import 这个文件\r\n */\r\n/* 颜色变量 */\r\n/* 行为相关颜色 */\r\n/* 文字基本颜色 */\r\n/* 背景颜色 */\r\n/* 边框颜色 */\r\n/* 尺寸变量 */\r\n/* 文字尺寸 */\r\n/* 图片尺寸 */\r\n/* Border Radius */\r\n/* 水平间距 */\r\n/* 垂直间距 */\r\n/* 透明度 */\r\n/* 文章场景相关 */.uni-popup[data-v-3193bb52]{position:fixed;z-index:99}.uni-popup.top[data-v-3193bb52], .uni-popup.left[data-v-3193bb52], .uni-popup.right[data-v-3193bb52]{top:var(--window-top)}.uni-popup .uni-popup__wrapper[data-v-3193bb52]{display:block;position:relative\r\n  /* iphonex 等安全区设置，底部安全区适配 */}.uni-popup .uni-popup__wrapper.left[data-v-3193bb52], .uni-popup .uni-popup__wrapper.right[data-v-3193bb52]{padding-top:var(--window-top);flex:1}.fixforpc-z-index[data-v-3193bb52]{z-index:999}.fixforpc-top[data-v-3193bb52]{top:0}', ""]), t.exports = e
		},
		"57f6": function(t)
		{
		...
		"63d7": function(t, e, n)
		{
			...
			var i = {
				...
				o = function()
				{
					...
					}, [t.prefixIcon || t.$slots.prefix ? n("v-uni-view",
					{
					...
					})], 1) : t._e(), t.suffixIcon || t.$slots.suffix ? n("v-uni-view",
					{
		...
		6416: function(t, e, n)
		{
			...
			var r = n("f0c5"),
				u = Object(r["a"])(o["default"], i["b"], i["c"], !1, null, "1a12f82f", null, !1, i["a"], void 0);
			e["default"] = u.exports
		},
		"688e": function(t, e, n)
		{
		...
		{
			var i = n("24fb");
			e = i(!1), e.push([t.i, '@charset "UTF-8";\r\n/**\r\n * 这里是uni-app内置的常用样式变量\r\n *\r\n * uni-app 官方扩展插件及插件市场（https://ext.dcloud.net.cn）上很多三方插件均使用了这些样式变量\r\n * 如果你是插件开发者，建议你使用scss预处理，并在插件代码中直接使用这些变量（无需 import 这个文件），方便用户通过搭积木的方式开发整体风格一致的App\r\n *\r\n */\r\n/**\r\n * 如果你是App开发者（插件使用者），你可以通过修改这些变量来定制自己的插件主题，实现自定义主题功能\r\n *\r\n * 如果你的项目同样使用了scss预处理，你也可以直接在你的 scss 代码中使用如下变量，同时无需 import 这个文件\r\n */\r\n/* 颜色变量 */\r\n/* 行为相关颜色 */\r\n/* 文字基本颜色 */\r\n/* 背景颜色 */\r\n/* 边框颜色 */\r\n/* 尺寸变量 */\r\n/* 文字尺寸 */\r\n/* 图片尺寸 */\r\n/* Border Radius */\r\n/* 水平间距 */\r\n/* 垂直间距 */\r\n/* 透明度 */\r\n/* 文章场景相关 */.btn[data-v-46047626]{padding:%?50?% 0}[data-v-46047626] .u-cell__value{color:#fff!important}[data-v-46047626] .uni-section{background-color:initial}.container[data-v-46047626]{display:flex;flex-direction:column;width:100%;height:100vh}.body[data-v-46047626]{padding:%?10?% %?50?% %?30?%;overflow-y:scroll;flex:1}', ""]), t.exports = e
		},
		"88c2": function(t, e, n)
		{
			"use strict";
					...
					s = {
						...
						methods:
						{
							init: function()
							{
								...
								{};
								t.duration && (this.durationTime = t.duration), this.animation = (0, u.createAnimation)(Object.assign(this.config, t), this)
							},
							onClick: function()
							{
								this.$emit("click",
							...
							step: function(e)
							{
								...
								if (this.animation)
								{
									...
									{
										var r;
										if ("object" === (0, a.default)(e[i]))(r = this.animation)[i].apply(r, (0, o.default)(e[i]));
							...
							open: function()
							{
								...
								var e = this.styleInit(!1),
									n = e.opacity,
									i = e.transform;
								"undefined" !== typeof n && (this.opacity = n), this.transform = i, this.$nextTick((function()
								{
									t.timer = setTimeout((function()
									{
										t.animation = (0, u.createAnimation)(t.config, t), t.tranfromInit(!1)
											.step(), t.animation.run(), t.$emit("change",
											{
												detail: t.isShow
											})
									}), 20)
							...
							{
								var e = this;
								this.animation && this.tranfromInit(!0)
									.step()
									.run((function()
									{
							...
							tranfromInit: function(t)
							{
								var e = this,
									...
									{
										var i = null;
										"fade" === n ? i = t ? 0 : 1 : (i = t ? "-100%" : "0", "zoom-in" === n && (i = t ? .8 : 1), "zoom-out" === n && (i = t ? 1.2 : 1), "slide-right" === n && (i = t ? "100%" : "0"), "slide-bottom" === n && (i = t ? "100%" : "0")), e.animation[e.animationMode()[n]](i)
									};
							...
							animationType: function(t)
							{
								return {
									...
									"zoom-in": "scaleX(".concat(t ? 1 : .8, ") scaleY(")
										.concat(t ? 1 : .8, ")"),
									"zoom-out": "scaleX(".concat(t ? 1 : 1.2, ") scaleY(")
										.concat(t ? 1 : 1.2, ")")
								}
							},
		...
		"93a2": function(t, e, n)
		{
			...
			n("feb5");
			var r = n("f0c5"),
				u = Object(r["a"])(o["default"], i["b"], i["c"], !1, null, "46047626", null, !1, i["a"], void 0);
			e["default"] = u.exports
		},
		9639: function(t, e, n)
		{
			...
			var i = function()
				{
					...
					}, [t._v(t._s(t.titleText))])], 1), "base" === t.mode ? n("v-uni-view",
					{
						staticClass: "uni-dialog-content"
					}, [t._t("default", [n("v-uni-text",
					{
						staticClass: "uni-dialog-content-text"
					}, [t._v(t._s(t.content))])])], 2) : n("v-uni-view",
					{
						staticClass: "uni-dialog-content"
					}, [t._t("default", ["checkbox" === t.inputType ? n("v-uni-input",
					{
					...
					}, [t._v(t._s(t.closeText))])], 1), n("v-uni-view",
					{
				...
				o = function()
				{
					...
					}, [n("v-uni-view",
					{
						on:
						{
							...
							{
								arguments[0] = e = t.$handleEvent(e), t.touchstart.apply(void 0, arguments)
							}
						}
					}, [t.maskShow ? n("uni-transition",
					{
						...
						on:
						{
							click: function(e)
							{
								arguments[0] = e = t.$handleEvent(e), t.onTap.apply(void 0, arguments)
							}
						}
			...
			var i = function()
				{
					...
					}, [t._v(t._s(t.subTitle))]) : t._e()], 1), n("v-uni-view",
					{
						staticClass: "uni-section-header__slot-right"
					}, [t._t("right")], 2)], 2), n("v-uni-view",
					{
		...
		d643: function(t, e, n)
		{
			...
			}, n("caad"), n("2532"), n("99af"), n("d3b7"), n("159b");
			var o = i(n("5530")),
				a = i(n("d4ec")),
				r = i(n("bee2")),
				u = function()
				{
					function t(e, n)
					{
						(0, a.default)(this, t), this.options = e, this.animation = uni.createAnimation((0, o.default)(
						{}, e)), this.currentStepAnimates = {}, this.next = 0, this.$ = n
					}
					return (0, r.default)(t, [
					{
						...
						value: function(t, e)
						{
							...
							}, s.includes(t))
							{
								...
								var o = "";
								"rotate" === t && (o = "deg"), i.styles.transform += "".concat(t, "(")
									.concat(e + o, ") ")
							}
					...
					},
					{
						...
						value: function()
						{
							var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] :
								...
								{},
								n = this.$.$refs["ani"].ref;
							if (n) return new Promise((function(i, a)
							{
								nvueAnimation.transition(n, (0, o.default)(
								{
									styles: t
								}, e), (function(t)
								{
			...
			s.concat(["opacity", "backgroundColor"], ["width", "height", "left", "right", "top", "bottom"])
				.forEach((function(t)
				{
		...
		d964: function(t, e, n)
		{
			...
			{
				value: !0
			}), e.default = void 0, n("99af"), n("14d9");
			var o = i(n("5bcf")),
				a = {
					name: "u-input",
					mixins: [uni.$u.mpMixin, uni.$u.mixin, o.default],
					...
					methods:
					{
						...
						{
							var e = this;
							this.$emit("blur", t.detail.value), uni.$u.sleep(50)
								.then((function()
								{
									e.focused = !1
