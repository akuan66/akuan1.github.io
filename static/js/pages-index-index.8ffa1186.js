	...
	["pages-index-index"],
	{
			...
			var a = {
				...
				n = function()
				{
					...
					}, e._l(e.list, (function(t)
					{
						...
						{
							staticClass: "my-text"
						}, [e._v(e._s(t.text))]), t.hot ? i("v-uni-view",
						{
							staticClass: "hot"
						}, [e._v("HOT")]) : e._e(), t.lockFlag && !e.lockVip ? i("u-icon",
						{
							attrs:
							{
								name: "lock",
					...
					}, [e._v("语音提示")]), i("u-switch",
					{
						...
						on:
						{
							change: function(t)
							{
								arguments[0] = t = e.$handleEvent(t), e.voiceOpenChange.apply(void 0, arguments)
							}
						}
					})], 1), i("v-uni-view",
					{
						...
						on:
						{
							click: function(t)
							{
								arguments[0] = t = e.$handleEvent(t), e.lockVipClick.apply(void 0, arguments)
							}
						}
					}, [i("v-uni-view",
					{
					...
					}, [i("v-uni-view", [i("u-code-input",
					{
						...
						on:
						{
							finish: function(t)
							{
								arguments[0] = t = e.$handleEvent(t), e.finish.apply(void 0, arguments)
							}
						}
					})], 1)], 1)], 1), i("v-uni-view",
					{
					...
					}, [i("u-popup",
					{
						...
						on:
						{
							close: function(t)
							{
								arguments[0] = t = e.$handleEvent(t), e.customShow = !1
							}
						}
					}, [i("v-uni-view", [e._l(e.userCustomList, (function(t)
					{
						return i("v-uni-view",
						{
							...
							on:
							{
								click: function(i)
								{
									arguments[0] = i = e.$handleEvent(i), e.goChess(t.id)
								}
							}
						}, [i("v-uni-view",
						{
							staticClass: "tip-text"
						}, [e._v(e._s(t.title))]), i("u-icon",
						{
							attrs:
							{
								name: "arrow-right",
					...
					})), i("v-uni-view",
					{
						...
						on:
						{
							click: function(t)
							{
								arguments[0] = t = e.$handleEvent(t), e.onNew.apply(void 0, arguments)
							}
						}
					}, [i("v-uni-view",
					{
		...
		"066c": function(e, t, i)
		{
			(function(e)
			{
				var t = i("7037")
					.default;
				i("cb29"), i("14d9"), i("a434"), i("ac1f"), i("5319"), i("d3b7"), i("3ca3"), i("ddb0"), i("2b3d"), i("9861"), i("e25e"), i("c975");
				var a = function(i, a)
				{
					...
					var s = this.pJS;
					a && Object.deepExtend(s, a), s.tmp.obj = {
					...
					{
						if (this.radius = (s.particles.size.random ? Math.random() : 1) * s.particles.size.value, s.particles.size.anim.enable && (this.size_status = !1, this.vs = s.particles.size.anim.speed / 100, s.particles.size.anim.sync || (this.vs = this.vs * Math.random())), this.x = a ? a.x : Math.random() * s.canvas.w, this.y = a ? a.y : Math.random() * s.canvas.h, this.x > s.canvas.w - 2 * this.radius ? this.x = this.x - this.radius : this.x < 2 * this.radius && (this.x = this.x + this.radius), this.y > s.canvas.h - 2 * this.radius ? this.y = this.y - this.radius : this.y < 2 * this.radius && (this.y = this.y + this.radius), s.particles.move.bounce && s.fn.vendors.checkOverlap(this, a), this.color = {}, "object" == t(e.value))
					...
					}, s.fn.particle.prototype.draw = function()
					{
						...
						if (e.color.rgb) var a = "rgba(" + e.color.rgb.r + "," + e.color.rgb.g + "," + e.color.rgb.b + "," + i + ")";
						else a = "hsla(" + e.color.hsl.h + "," + e.color.hsl.s + "%," + e.color.hsl.l + "%," + i + ")";
					...
					}, s.fn.particlesUpdate = function()
					{
						for (var e = 0; e < s.particles.array.length; e++)
						{
							...
							if (s.particles.opacity.anim.enable && (1 == t.opacity_status ? (t.opacity >= s.particles.opacity.value && (t.opacity_status = !1), t.opacity += t.vo) : (t.opacity <= s.particles.opacity.anim.opacity_min && (t.opacity_status = !0), t.opacity -= t.vo), t.opacity < 0 && (t.opacity = 0)), s.particles.size.anim.enable && (1 == t.size_status ? (t.radius >= s.particles.size.value && (t.size_status = !1), t.radius += t.vs) : (t.radius <= s.particles.size.anim.size_min && (t.size_status = !0), t.radius -= t.vs), t.radius < 0 && (t.radius = 0)), "bounce" == s.particles.move.out_mode) var a = {
								x_left: t.radius,
								x_right: s.canvas.w,
								y_top: t.radius,
								y_bottom: s.canvas.h
					...
					}, s.fn.modes.bubbleParticle = function(e)
					{
							...
							if (n <= s.interactivity.modes.bubble.distance)
							{
								if (o >= 0 && "mousemove" == s.interactivity.status)
								{
									if (s.interactivity.modes.bubble.size != s.particles.size.value)
										if (s.interactivity.modes.bubble.size > s.particles.size.value)
										{
											var c = e.radius + s.interactivity.modes.bubble.size * o;
									...
									{
										u = e.opacity - (s.particles.opacity.value - s.interactivity.modes.bubble.opacity) * o;
										u < e.opacity && u >= s.interactivity.modes.bubble.opacity && (e.opacity_bubble = u)
									}
								}
							}
						...
						else if (s.interactivity.events.onclick.enable && r("bubble", s.interactivity.events.onclick.mode))
						{
							var d = function(t, i, a, r, o)
							{
								if (t != i)
									if (s.tmp.bubble_duration_end)
									{
										if (void 0 != a)
										{
											var c = r - p * (r - t) / s.interactivity.modes.bubble.duration,
												l = t - c;
								...
								else if (n <= s.interactivity.modes.bubble.distance)
								{
									...
									if (u != t)
									{
										var d = r - p * (r - t) / s.interactivity.modes.bubble.duration;
							...
							{
								i = e.x - s.interactivity.mouse.click_pos_x, a = e.y - s.interactivity.mouse.click_pos_y, n = Math.sqrt(i * i + a * a);
								var p = ((new Date)
									.getTime() - s.interactivity.mouse.click_time) / 1e3;
								p > s.interactivity.modes.bubble.duration && (s.tmp.bubble_duration_end = !0), p > 2 * s.interactivity.modes.bubble.duration && (s.tmp.bubble_clicking = !1, s.tmp.bubble_duration_end = !1)
							}
					...
					}, s.fn.modes.repulseParticle = function(e)
					{
						if (s.interactivity.events.onhover.enable && r("repulse", s.interactivity.events.onhover.mode) && "mousemove" == s.interactivity.status)
						{
							...
							"bounce" == s.particles.move.out_mode ? (l.x - e.radius > 0 && l.x + e.radius < s.canvas.w && (e.x = l.x), l.y - e.radius > 0 && l.y + e.radius < s.canvas.h && (e.y = l.y)) : (e.x = l.x, e.y = l.y)
						}
							...
							if (s.tmp.repulse_finish || (s.tmp.repulse_count++, s.tmp.repulse_count == s.particles.array.length && (s.tmp.repulse_finish = !0)), s.tmp.repulse_clicking)
							{
								...
								p <= o && function()
								{
									...
									if (e.vx = f * Math.cos(t), e.vy = f * Math.sin(t), "bounce" == s.particles.move.out_mode)
									{
										...
										(i.x + e.radius > s.canvas.w || i.x - e.radius < 0) && (e.vx = -e.vx), (i.y + e.radius > s.canvas.h || i.y - e.radius < 0) && (e.vy = -e.vy)
									}
								}()
							}
					...
					}, s.fn.vendors.eventsListeners = function()
					{
						...
						{
							if (s.interactivity.mouse.click_pos_x = s.interactivity.mouse.pos_x, s.interactivity.mouse.click_pos_y = s.interactivity.mouse.pos_y, s.interactivity.mouse.click_time = (new Date)
								.getTime(), s.interactivity.events.onclick.enable) switch (s.interactivity.events.onclick.mode)
							{
								case "push":
					...
					}, s.fn.vendors.densityAutoParticles = function()
					{
						if (s.particles.number.density.enable)
						{
							...
							i < 0 ? s.fn.modes.pushParticles(Math.abs(i)) : s.fn.modes.removeParticles(i)
						}
					}, s.fn.vendors.checkOverlap = function(e, t)
					{
						for (var i = 0; i < s.particles.array.length; i++)
						{
							var a = s.particles.array[i],
								...
								r = e.y - a.y,
								o = Math.sqrt(n * n + r * r);
							o <= e.radius + a.radius && (e.x = t ? t.x : Math.random() * s.canvas.w, e.y = t ? t.y : Math.random() * s.canvas.h, s.fn.vendors.checkOverlap(e))
						}
					...
					{
						cancelAnimationFrame(s.fn.drawAnimFrame), o.remove(), pJSDom = null
					}, s.fn.vendors.drawShape = function(e, t, i, a, n, r)
					{
						...
						for (var u = 0; u < o; u++) e.lineTo(a, 0), e.translate(a, 0), e.rotate(l);
						e.fill(), e.restore()
					...
					}, s.fn.vendors.loadImg = function(t)
					{
						if (s.tmp.img_error = void 0, "" != s.particles.shape.image.src)
							if ("svg" == t)
							{
								...
								i.open("GET", s.particles.shape.image.src), i.onreadystatechange = function(t)
								{
									4 == i.readyState && (200 == i.status ? (s.tmp.source_svg = t.currentTarget.response, s.fn.vendors.checkBeforeDraw()) : (e.log("Error pJS - Image not found"), s.tmp.img_error = !0))
								}, i.send()
							}
						else
						{
				...
				}(), window.pJSDom = [], window.particlesJS = function(e, t)
				{
					...
					r.className = "particles-js-canvas-el", r.style.width = "100%", r.style.height = "100%";
		...
		"1dfe": function(e, t, i)
		{
			...
			i("c945");
			var o = i("f0c5"),
				s = Object(o["a"])(n["default"], a["b"], a["c"], !1, null, "3f114883", null, !1, a["a"], void 0);
			t["default"] = s.exports
		},
		"27a0": function(e, t, i)
		{
		...
		{
			var a = i("24fb");
			t = a(!1), t.push([e.i, '@charset "UTF-8";\r\n/**\r\n * 这里是uni-app内置的常用样式变量\r\n *\r\n * uni-app 官方扩展插件及插件市场（https://ext.dcloud.net.cn）上很多三方插件均使用了这些样式变量\r\n * 如果你是插件开发者，建议你使用scss预处理，并在插件代码中直接使用这些变量（无需 import 这个文件），方便用户通过搭积木的方式开发整体风格一致的App\r\n *\r\n */\r\n/**\r\n * 如果你是App开发者（插件使用者），你可以通过修改这些变量来定制自己的插件主题，实现自定义主题功能\r\n *\r\n * 如果你的项目同样使用了scss预处理，你也可以直接在你的 scss 代码中使用如下变量，同时无需 import 这个文件\r\n */\r\n/* 颜色变量 */\r\n/* 行为相关颜色 */\r\n/* 文字基本颜色 */\r\n/* 背景颜色 */\r\n/* 边框颜色 */\r\n/* 尺寸变量 */\r\n/* 文字尺寸 */\r\n/* 图片尺寸 */\r\n/* Border Radius */\r\n/* 水平间距 */\r\n/* 垂直间距 */\r\n/* 透明度 */\r\n/* 文章场景相关 */#particles[data-v-6ac0b7df]{position:absolute;width:100%;height:100%;background-repeat:no-repeat;background-size:cover;background-position:50% 50%}', ""]), e.exports = t
		},
		"4be7": function(e, t, i)
		{
			"use strict";
			...
			var a = function()
				{
					...
					}, [e._l(e.codeLength, (function(t, a)
					{
						return i("v-uni-view",
						{
							...
							style: [e.itemStyle(a)]
						}, [e.dot && e.codeArray.length > a ? i("v-uni-view",
						{
						...
						}, [e._v(e._s(e.codeArray[a]))]), "line" === e.mode ? i("v-uni-view",
						{
							staticClass: "u-code-input__item__line",
							style: [e.lineStyle]
						}) : e._e(), e.isFocus && e.codeArray.length === a ? i("v-uni-view",
						{
					...
					})), i("v-uni-input",
					{
						...
						on:
						{
							input: function(t)
							{
								arguments[0] = t = e.$handleEvent(t), e.inputHandler.apply(void 0, arguments)
							},
							focus: function(t)
							{
		...
		"5d26": function(e, t, i)
		{
			...
			{
				value: !0
			}), t.default = void 0, i("a9e3"), i("99af"), i("ac1f"), i("5319");
			var n = a(i("ea24")),
				r = {
					name: "u-code-input",
					...
					computed:
					{
						...
						itemStyle: function()
						{
							...
							return function(t)
							{
								...
								return "box" === e.mode && (a.border = "".concat(e.hairline ? .5 : 1, "px solid ")
									.concat(e.borderColor), 0 === uni.$u.getPx(e.space) && (0 === t && (a.borderTopLeftRadius = "3px", a.borderBottomLeftRadius = "3px"), t === e.codeLength.length - 1 && (a.borderTopRightRadius = "3px", a.borderBottomRightRadius = "3px"), t !== e.codeLength.length - 1 && (a.borderRight = "none"))), t !== e.codeLength.length - 1 ? a.marginRight = i(e.space) : a.marginRight = 0, a
							}
						},
						codeArray: function()
						{
						...
						{
							var e = {};
							return e.height = this.hairline ? "2px" : "4px", e.width = uni.$u.addUnit(this.size), e.backgroundColor = this.borderColor, e
						}
					},
					methods:
					{
						inputHandler: function(e)
						{
							var t = this,
								i = e.detail.value;
							this.inputValue = i, this.disabledDot && this.$nextTick((function()
								{
									t.inputValue = i.replace(".", "")
								})), this.$emit("change", i), this.$emit("input", i), String(i)
								.length >= Number(this.maxlength) && this.$emit("finish", i)
						}
					}
				};
			t.default = r
		...
		"5de6": function(e, t, i)
		{
			...
			var a = {
				...
				n = function()
				{
					...
					}, [e.title ? i("v-uni-text",
					{
						staticClass: "u-modal__title"
					}, [e._v(e._s(e.title))]) : e._e(), i("v-uni-view",
					{
						staticClass: "u-modal__content",
						style:
						{
							paddingTop: (e.title ? 12 : 25) + "px"
						}
					}, [e._t("default", [i("v-uni-text",
					{
						staticClass: "u-modal__content__text"
					}, [e._v(e._s(e.content))])])], 2), e.$slots.confirmButton ? i("v-uni-view",
					{
						staticClass: "u-modal__button-group--confirm-button"
					}, [e._t("confirmButton")], 2) : [i("u-line"), i("v-uni-view",
					{
						staticClass: "u-modal__button-group",
						style:
						{
							flexDirection: e.buttonReverse ? "row-reverse" : "row"
						}
					}, [e.showCancelButton ? i("v-uni-view",
					{
						staticClass: "u-modal__button-group__wrapper u-modal__button-group__wrapper--cancel",
						class: [e.showCancelButton && !e.showConfirmButton && "u-modal__button-group__wrapper--only-cancel"],
						attrs:
						{
							"hover-stay-time": 150,
						...
						on:
						{
							click: function(t)
							{
								arguments[0] = t = e.$handleEvent(t), e.cancelHandler.apply(void 0, arguments)
							}
						}
					}, [i("v-uni-text",
					{
					...
					}, [e._v(e._s(e.cancelText))])], 1) : e._e(), e.showConfirmButton && e.showCancelButton ? i("u-line",
					{
						attrs:
						{
							direction: "column"
						}
					}) : e._e(), e.showConfirmButton ? i("v-uni-view",
					{
						staticClass: "u-modal__button-group__wrapper u-modal__button-group__wrapper--confirm",
						class: [!e.showCancelButton && e.showConfirmButton && "u-modal__button-group__wrapper--only-confirm"],
						attrs:
						{
							"hover-stay-time": 150,
							"hover-class": "u-modal__button-group__wrapper--hover"
						...
						on:
						{
							click: function(t)
							{
								arguments[0] = t = e.$handleEvent(t), e.confirmHandler.apply(void 0, arguments)
							}
						}
					}, [e.loading ? i("u-loading-icon") : i("v-uni-text",
					{
						staticClass: "u-modal__button-group__wrapper__text",
						style:
						{
					...
					}, [e._v(e._s(e.confirmText))])], 1) : e._e()], 1)]], 2)], 1)
				},
				r = []
		},
		"6b46": function(e, t, i)
		...
		7260: function(e, t, i)
		{
			...
			i("e791");
			var o = i("f0c5"),
				s = Object(o["a"])(n["default"], a["b"], a["c"], !1, null, "4cff2aef", null, !1, a["a"], void 0);
			t["default"] = s.exports
		},
		"7bcf": function(e, t, i)
		{
		...
		"851d": function(e, t, i)
		{
			...
			i("1b56");
			var o = i("f0c5"),
				s = Object(o["a"])(n["default"], a["b"], a["c"], !1, null, "53a9fd8a", null, !1, a["a"], void 0);
			t["default"] = s.exports
		},
		"901e": function(e, t, i)
		{
		...
		c397: function(e, t, i)
		{
			...
			{
				value: !0
			}), t.default = void 0, i("d3b7"), i("c740");
			var n = a(i("5530")),
				r = a(i("36cd")),
				o = i("26cb"),
				s = {
					...
					{}, (0, o.mapState)(["voiceOpen", "userCustomList", "soundFlag", "identificationCode", "lockVip"])),
					methods: (0, n.default)((0, n.default)(
					{}, (0, o.mapMutations)(["setVoiceOpen", "setSoundFlag", "setLockVip"])),
					{},
					{
						...
						finish: function(e)
						{
							...
							var i = setTimeout((function()
							{
								...
								a ? (uni.hideLoading(), t.pswShow = !1, t.setShow = !1, uni.showModal(
								{
									content: "激活成功！",
									showCancel: !1,
									success: function(e)
						...
						weGo: function(e)
						{
							...
							{
								if (!this.stop)
									if (this.stop = !0, e.id != this.list[this.list.length - 1].id)
									{
						...
						onCustom: function()
						{
							this.userCustomList.length ? (this.customShow = !0, this.stop = !1) : (this.list[this.list.length - 1].goFlag = !0, setTimeout((function()
							{
								uni.reLaunch(
								{
									url: "/pagesA/custom/custom"
		...
		f3b1: function(e, t, i)
		{
			...
			i("4346");
			var o = i("f0c5"),
				s = Object(o["a"])(n["default"], a["b"], a["c"], !1, null, "12709030", null, !1, a["a"], void 0);
			t["default"] = s.exports
		},
		fe73: function(e, t, i)
		{
